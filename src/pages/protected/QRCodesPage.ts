...
@customElement('qr-codes-page')
export class QRCodesPage extends LitElement {
      ...
      <div class="sidebar">
        ...
        <nav class="sidebar-nav">
          <div class="nav-section">
            ...
            <button class="nav-item active" @click=${() => this.navigateTo('/qr-codes')}>
              <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  private navigateTo(path: string) {
    console.log(`[QRCodes] Navigating to ${path}`);
  ...
  private handleLogout() {
    console.log('[QRCodes] Logout requested');
  }
}